...
fichier = pd.read_csv('copropriété.csv', delimiter=';', encoding='latin-1')
...
def hash_coordonnées(column, row):
    ...
    #Jusqu'ici tout marche bien il me semble en tout cas aucun retour de bug 
...
#print (fichier)
df.to_csv("liste.csv", sep=';', index=False)